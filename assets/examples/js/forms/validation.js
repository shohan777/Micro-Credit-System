    ...
    $('#exampleStandardForm').formValidation({
      ...
      fields: {
        ...
        : {
          validators: {
            notEmpty: {
              message: 'The Account no is required and cannot be empty'
            }
          }
        },
        monthlyamount: {
        ...
        numberofyear: {
          validators: {
            notEmpty: {
              message: 'The number of year is required and cannot be empty'
            }
          }
        },
        date: {
            validators: {
              notEmpty: {
                message: 'The Deposite Date is required and cannot be empty'
              }
            }
        },
        standard_email: {
        ...
        loanamount: {
          validators: {
            notEmpty: {
              message: 'The Loan Amount no is required and cannot be empty'
            }
          }
        },
        fdramount: {
          validators: {
            notEmpty: {
              message: 'The FDR Amount is required and cannot be empty'
            }
          }
        },
        withdrawdate: {
          validators: {
            notEmpty: {
              message: 'The Withdraw Date is required and cannot be empty'
            }
          }
        },
        amount: {
          validators: {
            notEmpty: {
              message: 'The Income Amount is required and cannot be empty'
            }
          }
        },
        entryby: {
        ...
        fieldname: {
          validators: {
            notEmpty: {
              message: 'The field Name required and cannot be empty'
            }
          }
        },
        fdrclosedate: {
