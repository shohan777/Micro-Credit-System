...
<div class="page animsition vertical-align text-center" data-animsition-in="fade-in"
  data-animsition-out="fade-out">
	...
	<div class="page-content padding-30 vertical-align-middle" style="background:#253847ba;border-radius: 5px;">
      <div class="brand">
      ...
      <p> {{ trans('app.sing_into_your_pages_account')}}</p>
       <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
		...
		<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
						...
						<input id="email" type="text" class="form-control" placeholder="{{ trans('app.email_address')}} " name="email" value="{{ old('email') }}" required>
