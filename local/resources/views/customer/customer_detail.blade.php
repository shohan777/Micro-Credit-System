            ...
            <div class="widget widget-shadow text-center">
                <div class="widget-header">
                    <div class="widget-header-content">
                        ...
                        @php
                        $gurdian_name = explode('-', $customer_list['fathername']);
                        @endphp
                        ...
                        <p style="color:#016ef1;font-weight:700">Balance: {{ $customer_list['balance'] }} BDT</p>
                        <p style="font-size: 12px" class="profile-job">Opening Date: {{ date('M d, Y', strtotime($customer_list['opening_date'])) }}</p>
                    </div>
                </div>
            </div>
            <!-- End Page Widget -->
                ...
                <div class="panel-body nav-tabs-animate nav-tabs-horizontal">
                    <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
                        <li class="dropdown" role="presentation" style="display:block">
                            <a style="cursor:pointer" class="dropdown-toggle" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <span class="caret"></span> Personal </a>
                            <ul class="dropdown-menu" role="menu">
                                <li role="presentation" style="display: block;"><a data-toggle="tab" href="#personal"
                                        aria-controls="personal" role="tab">Personal</a></li>
                                <li role="presentation"><a data-toggle="tab" href="#nominee" aria-controls="nominee"
                                        role="tab">Nominee</a></li>
                                <li role="presentation"><a data-toggle="tab" href="#introducer" aria-controls="introducer"
                                        role="tab">Introducer</a></li>
                            </ul>
                        </li>
                        <li class="dropdown" role="presentation" style="display:block">
                            <a style="cursor:pointer" class="dropdown-toggle" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <span class="caret"></span> Transaction </a>
                            <ul class="dropdown-menu" role="menu">
                                <li role="presentation" style="display: block;"><a data-toggle="tab" href="#deposite_form"
                                        aria-controls="deposite_form" role="tab">Deposite</a></li>
                                <li role="presentation"><a data-toggle="tab" href="#withdraw_form" aria-controls="withdraw_form"
                                        role="tab">Withdraw</a></li>
                            </ul>
                        </li>
                        <li role="presentation"><a style="cursor:pointer" data-toggle="tab" href="#transaction_history" aria-controls="transaction_history" role="tab">Transaction History</a></li>
                        <li role="presentation"><a style="cursor:pointer" data-toggle="tab" href="#cus_signature" aria-controls="cus_signature" role="tab">Signature</a></li>
                    </ul>
                    <div class="tab-content">
                            ...
                            <div class="meta-wrapper">
                                ...
                                <div class="next-expected-date">
                                    <span class="next-deposite-date pull-right">Status: <strong>{{
                                            ($loan_data['loanstatus'] == 'active' && $loan_data['loanpermission'] ==
                                            'approved') ? 'Running' : '' }}</strong></span>
                                </div>
                            </div>
                                    ...
                                    <table class="table no-border">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>#{{ $loan_data['loanapplytranxid'] }}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td>
                                                    <p>{{ number_format($loan_data['loanamount'], 0, '.', ',') }} BDT</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                    <p>Loan Total Amount</p>
                                                </th>
                                                <td>
                                                    <p>{{ number_format($loan_data['loantotal'], 0, '.', ',') }} BDT</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td>
                                                    <p>{{ number_format($loan_data['loandue'], 0, '.', ',') }} BDT</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                    <p>Current Loan Terms</p>
                                                </th>
                                                <td>
                                                    <p>{{ str_replace('-', ' / ', $loan_data['loanterms']) }}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p><i class="fa fa-calendar"></i> {{ date('F d, Y',
                                                        strtotime($loan_data['loanending'])) }}</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="tab-pane animation-slide-left" id="fdr_summary" role="tabpanel">
                            <div class="meta-wrapper">
                                ...
                                <div class="next-expected-date">
                                    <span class="next-deposite-date pull-right">Status: <strong>{{
                                            ($fdr_data['fdrstatus'] == 'active' && $fdr_data['fdrpermission'] ==
                                            'approved') ? 'Running' : '' }}</strong></span>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                                    ...
                                    <table class="table no-border">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>{{ number_format($fdr_data['fdramount'], 0, '.', ',') }} BDT</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td>
                                                    <p>{{ str_replace('-', ' / ', $fdr_data['fdrterms']) }}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td>
                                                    <p>{{ str_replace('-', ' / ', $fdr_data['monthlyamount']) }} BDT</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                ...
                                                <td>
                                                    <p><i class="fa fa-calendar"></i> {{ date('F d, Y',
                                                        strtotime($fdr_data['serviceenddate'])) }}</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="tab-pane animation-slide-left" id="dps_deposite" role="tabpanel">
                            <div class="meta-wrapper">
                                ...
                                <div class="next-expected-date">
                                    <span class="next-deposite-date pull-right">Next Deposite Date: <strong>{{ date('F
                                            d, Y', strtotime($dps_record['nextdate'])) }}</strong></span>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <!-- Example Basic Form -->
                                    ...
                                    <form action="{{ url('/dps-deposite') }}" method="POST" autocomplete="off" id="exampleStandardForm">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input style="color:#009688;font-weight:700" type="text" class="form-control round"
                                                    id="monthlyamount" name="monthlyamount" placeholder="Montly Balance"
                                                    value="{{ $customer_list['monthlyamount'] }}" autocomplete="off"
                                                    readonly />
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="control-label" for="date">Deposite Date</label>
                                                <div class="input-group input-group-icon">
                                                    <input type="text" class="form-control round datepicker" id="date"
                        ...
                        <div class="tab-pane animation-slide-left" id="fdr_deposite" role="tabpanel">
                            <div class="meta-wrapper">
                                ...
                                <div class="next-expected-date">
                                    <span class="next-deposite-date pull-right">Next Withdraw Date: <strong>{{ date('F
                                            d, Y', strtotime($fdr_data['nextwithdrawdate'])) }}</strong></span>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <!-- Example Basic Form -->
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="input-group input-group-icon">
                                                    <input style="color:#009688;font-weight:700" type="text" class="form-control round"
                                                        id="monthlyamount" name="monthlyamount" placeholder="Montly Balance"
                                                        value="{{ $fdr_data['monthlyamount'] }}" autocomplete="off"
                                                        readonly />
                                                    <span class="input-group-addon">
                                                        <span>৳</span>
                                                    </span>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="input-group input-group-icon">
                                                    <input type="text" class="form-control round datepicker" id="withdrawdate"
                                                        name="withdrawdate" autocomplete="off">
                                                    <span class="input-group-addon">
                                                        <span class="icon fa fa-calendar" aria-hidden="true"></span>
                                                    </span>
                                                </div>
                            ...
                            <div class="meta-wrapper">
                                ...
                                <div class="next-expected-date pull-right">
                                    <span class="next-deposite-date">Next Deposite Date: <strong>{{ date('F d, Y',
                                            strtotime($loan_data['next_collection_date'])) }}</strong></span>
                                    <span class="loan-miss-count">Late Count ( <strong>{{ $loan_data['loanfailcount']
                                            }}</strong> )</span>
                                </div>
                                @endif
                            </div>
                                    ...
                                    <form action="{{ url('/loan-deposite') }}" method="POST" autocomplete="off" id="exampleStandardForm">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="input-group input-group-icon">
                                                    <input style="color:#009688;font-weight:700" type="text" class="form-control round"
                                                        ...
                                                        value="{{ ($loan_data['dailyamount']) ? $loan_data['dailyamount'] : '' }}"
                                                        autocomplete="off" />
                                                    <span class="input-group-addon">
                                                        <span>৳</span>
                                                    </span>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="input-group input-group-icon">
                                                    <input type="text" class="form-control round datepicker" id="date"
                                                        name="receivedate" autocomplete="off">
                                                    <span class="input-group-addon">
                                                        <span class="icon fa fa-calendar" aria-hidden="true"></span>
                                                    </span>
                                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="text-muted"><i class="fa fa-calendar"></i> {{
                                                            date('F d, Y', strtotime($record['date'])) }}</span>
                                                    </td>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="danger">
                                                    ...
                                                    <td>#{{ $record->loanno }}</td>
                                                    <td>
                                                        <span><i class="fa fa-calendar"></i> {{ date('F d, Y',
                                                            strtotime($record->receivedate)) }}</span>
                                                    </td>
                                                    <td>0</td>
                                                    <td>Nill</td>
                                                </tr>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{ ($gurdian_name[0] == 'F') ? 'Father Name' : 'Husband Name' }}</th>
                        ...
                        <div class="tab-pane animation-slide-left" id="nominee" role="tabpanel">
                            @php
                            $gurdian_name = explode('-', $customer_list['nomfathername']);
                            @endphp
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($customer_list['nompic'])
                                                    <img style="border-radius: initial" src="{{URL::to('/uploads', $customer_list['nompic'])}}" alt="...">
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                @if($customer_list['nomsignature'])
                                                    <img style="border-radius: initial" src="{{URL::to('/uploads', $customer_list['nomsignature'])}}" alt="...">
                                                @endif
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="tab-pane animation-slide-left" id="deposite_form" role="tabpanel">
                            <!-- Example Basic Form -->
                            <div class="example-wrap">
                                <h4 class="example-title" style="margin-top:20px;font-weight:700">Deposite Form</h4>
                                <div class="example">
                                    <form action="{{ url('customer_transaction') }}" method="POST" autocomplete="off">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="tranx_type" value="customer_deposite">
                                        <input type="hidden" name="accountNo" value="{{ $customer_list['accountNo'] }}">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label class="control-label" for="amount">Deposite Amount</label>
                                                <div class="input-group input-group-icon">
                                            ...
                                            <div class="form-group col-sm-6">
                                                <label class="control-label floating-label" for="trans_date">Deposite
                                                    Date</label>
                                                <div class="input-group input-group-icon">
                                                    <input type="text" class="form-control datepicker" id="trans_date"
                                                        name="trans_date" autocomplete="off">
                                                    <span class="input-group-addon">
                                                        <span class="icon fa fa-calendar" aria-hidden="true"></span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="form-group col-sm-12">
                                                <label class="control-label floating-label" for="receipt_no">Receipt No</label>
                                                <div class="input-group input-group-icon">
                        ...
                        <div class="tab-pane animation-slide-left" id="withdraw_form" role="tabpanel">
                            <!-- Example Basic Form -->
                            <div class="example-wrap">
                                <h4 class="example-title" style="margin-top:20px;font-weight:700">Withdraw Form</h4>
                                <div class="example">
                                    <form action="{{ url('customer_transaction') }}" method="POST" autocomplete="off">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="tranx_type" value="customer_withdraw">
                                        <input type="hidden" name="accountNo" value="{{ $customer_list['accountNo'] }}">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                <label class="control-label floating-label" for="trans_date">Withdraw
                                                    Date</label>
                                                <div class="input-group input-group-icon">
                                                    <input type="text" class="form-control datepicker" id="trans_date"
                                                        name="trans_date" autocomplete="off">
                        ...
                        {{-- Transaction History --}}
                        <div class="tab-pane animation-slide-left" id="transaction_history" role="tabpanel">
                            <!-- Example Responsive -->
                            <div class="example-wrap">
                                <h4 class="example-title" style="margin-top:20px;font-weight:700;text-decoration:underline">Transaction History</h4>
                                <div class="example">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $history->amount }} BDT</td>
                                                    <td style="color:#016ef1;font-weight:700">{{ $history->current_balance }} BDT</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                        ...
                        {{-- Customer Signature --}}
                        <div class="tab-pane animation-slide-left" id="cus_signature" role="tabpanel">
                            <div class="example-wrap">
                                <a style="margin-top:20px;font-weight:700;text-decoration:underline;width:100%;text-align:center" class="avatar avatar-lg" href="javascript:void(0)">
                                    @if($customer_list['signaturepic'])
                                    <img id="cus_signature_img" style="border-radius: initial" src="{{URL::to('/uploads', $customer_list['signaturepic'])}}" alt="...">
                                    @endif
                                </a>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function(){
        $('#cus_signature_img').hover(function() {
            $("#cus_signature_img").addClass('img_transition');
        
        }, function() {
            $("#cus_signature_img").removeClass('img_transition');
        });
    });
</script>
@stop