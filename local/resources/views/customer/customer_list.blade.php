    ...
    <div class="col-md-12">
        ...
        <div class="panel" id="customerList">
            ...
            <div class="bs-example" data-example-id="single-button-dropdown" style="float:right;padding: 14px 29px 0 0;">
                <div class="btn-group">
                    <form class="form-inline ng-pristine ng-valid" action="{{URL::to('customer-list')}}" method="get">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-xs btn-primary" style="color:#fff;text-decoration: none;" href="{{ url('/customer-detail', $customer->id) }}">
                                                <i class="icon fa-eye" aria-hidden="true"></i> View</a>
                                            <a class="btn btn-xs btn-info" style="color:#fff;text-decoration: none;" href="{{ url('/customer-edit', $customer->id) }}">
                                                <i class="icon fa-edit" aria-hidden="true"></i> Edit</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
