    ...
    <div class="col-md-12">
        ...
        <div class="panel" id="customerList">
            <div class="panel-heading" style="float:left;">
                <h3 class="panel-title">Deposite Report</h3>
            </div>
            <div class="bs-example" data-example-id="single-button-dropdown" style="float:right;padding: 14px 29px 0 0;">
                <div class="btn-group">
                    <form class="form-inline ng-pristine ng-valid" action="{{URL::to('/income-report')}}" method="get">
                        <div class="form-group">
                            <label for="search">Search For Deposite: </label>
                ...
                <div class="example-wrap">
                    <div class="example">
                        ...
                        <div class="table-responsive">
                            ...
                            {{ $income_data->appends(Request::only('search'))->links() }}
                        </div>
                        @else
