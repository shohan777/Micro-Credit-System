    ...
    <div class="col-md-12">
        ...
        <div class="panel" id="customerList">
            ...
            <div class="bs-example" data-example-id="single-button-dropdown" style="float:right;padding: 14px 29px 0 0;">
                ...
                <a style="display:none" class="btn btn-primary" href="{{ url('/fdr-profit-transfer') }}">FDR Profit Transfer</a>
            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a style="text-decoration: none;" href="{{ url('/fdr-account-detail', $customer->id) }}">
