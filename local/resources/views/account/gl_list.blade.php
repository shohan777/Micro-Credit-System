    ...
    <div class="col-md-12">
        ...
        <div class="panel" id="customerList">
            <div class="panel-heading" style="float:left;">
                <h3 class="panel-title">Entry GL</h3>
            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a style="text-decoration: none;" href="{{ url('/gl-entry', $head->id) }}"><i class="icon fa-plus" aria-hidden="true"></i> Entry</a></td>
                                    </tr>
                                    @endforeach
