                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a style="text-decoration: none;" href="{{ url('/income-ledger/detail', $head->id) }}"><i class="icon fa-eye" aria-hidden="true"></i> view</a></td>
                                    </tr>
                                    @endforeach
