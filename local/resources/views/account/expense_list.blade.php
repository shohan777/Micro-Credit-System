    ...
    <div class="col-md-12">
        ...
        <div class="panel" id="customerList">
            <div class="panel-heading" style="float:left;">
                <h3 class="panel-title">Income Ledger</h3>
            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a style="text-decoration: none;" href="{{ url('/expense-ledger/detail', $head->id) }}"><i class="icon fa-eye" aria-hidden="true"></i> view</a></td>
                                    </tr>
                                    @endforeach
