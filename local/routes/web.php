...
// Customer
Route::get('/customer-registration', 'CustomerController@registration');
Route::post('/customer-registration', 'CustomerController@registration');
Route::get('/customer-list', 'CustomerController@customerList');
Route::get('/customer-detail/{id}', 'CustomerController@customerDetail');
Route::get('/customer-edit/{id}', 'CustomerController@customerEdit');
Route::post('/customer-edit/{id}', 'CustomerController@customerEdit');
Route::post('/customerImageUpload/{id}', 'CustomerController@imageUpload');
Route::get('/getCustomer', 'CustomerController@getCustomer');
Route::get('/getCustomerLoan', 'CustomerController@getCustomerLoan');
Route::get('/getCustomerfdr', 'CustomerController@getCustomerFdr');
Route::post('/customer_transaction', 'CustomerController@customer_transaction');

// Services
Route::get('/dps-apply', 'ServiceController@dpsApply');
Route::post('/dps-deposite', 'ServiceController@dpsDeposite');

Route::get('/fdr-apply', 'ServiceController@fdrApply');
Route::post('/fdr-apply', 'ServiceController@fdrApply');
Route::post('/fdr-deposite', 'ServiceController@fdrDeposite');
Route::get('/fdr-account', 'ServiceController@fdrAccount');
Route::get('/fdr-account-detail/{id}', 'ServiceController@fdrAccountDetail');
Route::post('/fdr-account-close/{id}', 'ServiceController@closeFdrAccount');

Route::get('/loan-apply', 'ServiceController@loanApply');
Route::post('/loan-apply', 'ServiceController@loanApply');
Route::get('/loan-accounts', 'ServiceController@loanAccount');
Route::get('/loan-account-detail/{id}', 'ServiceController@loanAccountDetail');
Route::post('/loan-approval', 'ServiceController@loanApproval');
Route::post('/loan-deposite', 'ServiceController@loanDeposite');
Route::get('/loan-collection', 'ServiceController@loanCollection');
Route::post('/repermit-loan', 'ServiceController@rePermitLoan');
Route::post('/custom-collection', 'ServiceController@customCollection');

Route::get('/daily-loan-not-collect-pdf/{type}', 'ServiceController@dailyLoanNotCollectPdf');

Route::get('/fdr-profit-transfer', 'ServiceController@fdrProfitTransfer');

// Archive
Route::get('/loan-archive', 'CustomerController@loanArchive');
Route::get('/fdr-archive', 'CustomerController@fdrArchive');

// Transaction
Route::get('/income-trans', 'AccountController@incomeTrans');
Route::post('/income-trans', 'AccountController@incomeTrans');
Route::get('/expense-trans', 'AccountController@expenseTrans');
Route::post('/expense-trans', 'AccountController@expenseTrans');

// Field
Route::get('field', 'SettingController@field');
Route::post('field', 'SettingController@field');

// Banking Setting
Route::get('/banking-setting', 'SettingController@bankingSetting');
Route::post('/banking-setting', 'SettingController@bankingSetting');

// Report
Route::get('/income-report', 'AccountController@incomeReport');
Route::get('/expense-report', 'AccountController@expenseReport');
Route::get('/daily-loan-collection', 'ServiceController@dailyLoanCollection');
Route::post('/daily-loan-collection', 'ServiceController@dailyLoanCollection');
Route::get('/daily-loan-collection-pdf', 'ServiceController@dailyLoanCollectionPdf');
Route::get('/daily-loan-collection-print', 'ServiceController@dailyLoanCollectionPrint');
Route::get('/monthly-loan-collection', 'ServiceController@monthlyLoanCollection');
Route::get('/monthly-loan-collection-pdf', 'ServiceController@monthlyLoanCollectionPdf');
Route::get('/monthly-loan-collection-print', 'ServiceController@monthlyLoanCollectionPrint');

// Ledger Account
Route::get('/savings-account-ledger', 'AccountController@savingsAccountLedger');
Route::get('/savings-account-ledger/detail/{accountNo}', 'AccountController@savingsLedgerDetail');
Route::get('/fdr-account-ledger', 'AccountController@fdrAccountLedger');
Route::get('/fdr-account-ledger/detail/{id}', 'AccountController@fdrLedgerDetail');
Route::get('/loan-account-ledger', 'AccountController@loanAccountLedger');
Route::post('/loan-account-ledger', 'AccountController@loanAccountLedger');
Route::get('/loan-account-ledger/detail/{id}', 'AccountController@loanLedgerDetail');
Route::post('/loan-account-ledger/detail/{id}', 'AccountController@loanLedgerDetail');
Route::get('/income-ledger', 'AccountController@incomeAccountLedger');
Route::get('/income-ledger/detail/{id}', 'AccountController@incomeLedgerDetail');
Route::get('/expense-ledger', 'AccountController@expenseAccountLedger');
Route::get('/expense-ledger/detail/{id}', 'AccountController@expenseLedgerDetail');
// General Ledger
Route::get('/gl-list/{type}', 'AccountController@generalLedgerList');
Route::get('/gl-entry/{id}', 'AccountController@generalLedgerEntry');
Route::post('/gl-entry/{id}', 'AccountController@generalLedgerEntry');
Route::get('/gl-ledger/detail/{id}', 'AccountController@generalLedger');

Route::get('/head-balance', 'AccountController@headBalance');

// test
Route::get('/dayCountBetweenDates', 'ServiceController@holidayCountBetweenDates');

// Holiday
Route::get('holiday', 'SettingController@holiday');
Route::post('holiday', 'SettingController@holiday');

// Transaction Head
Route::get('/transaction-head', 'SettingController@transactionHead');
Route::post('/transaction-head', 'SettingController@transactionHead');
/* send email */
