...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2018 at 12:40 PM
...
(118, 1, 'Trx-loan-D1543303986', 1100, '2018-11-27', 100000, 118000, 118000, 18, '0-110', 1073, '2018-11-28', '2019-04-04', 0, 'active', 'approved', '2018-11-27 01:33:06', '2018-11-27 01:33:12');
...
CREATE TABLE `loan_rocords` (
  ...
  `accountNo` int(11) NOT NULL,
  `loanno` int(11) DEFAULT NULL,
  `loantranxid` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
